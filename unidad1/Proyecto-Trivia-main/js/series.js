const preguntas = [
    {
        ...
        respuestas: ["Gabriel Garcia Marquez", "Pablo Neruda", "Jorge Luis Borges", "Mario Vargas Llosa"],
        correcta: 3
    },
    {
        pregunta: "¿Novela Colombiana ganadora del Record Guinnes en 2010?",
        respuestas: ["Las Juanas", "Yo soy Betty la fea", "Doña Barbara", "El Clon"],
        correcta: 1
    },
    {
        pregunta: "¿No,bre del personaje principal de la novela Los Reyes?",
        respuestas: ["Andres Reyes", "Edilberto Reyes", "Mario Reyes", "Juan Reyes"],
        correcta: 1
    }
